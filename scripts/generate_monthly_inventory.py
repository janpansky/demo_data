...
def generate_monthly_inventory(today, existing_product_ids):
    """
    Generate new monthly inventory records.
    If monthly_inventory.csv already has a record for the current month (inventory_month equals today's month), returns [].
    """
